...
<div class="profile_wrapper row">
    <div id="reg_menu" class="container" style="display: flex; justify-content: center; flex-direction: column">
        ...
        <h2 style="font-family: 'SF Pro Display',sans-serif;font-style: normal;font-weight: 600;font-size: 18px;line-height: 128.91%;/* or 23px */text-align: center;color: #000000;">Добро пожаловать в приложение <span style="color: #007AFF;">BeBetter.</span> Перед началом <span style="color: #007AFF;">работы расскажите о себе</span></h2>
        <div class="profile_logo" style="display: flex; justify-content: center">
        ...
        <input class="input_response" id="date"  style="border: 1px solid #DEDEDE;box-sizing: border-box;width:100%!important;border-radius: 7px;width:100%;height: 43px; margin-top: 15px!important; margin: 0 auto; padding-left: 15px;background-color: #ffffff; outline: none" type="text" placeholder="Дата рождения">
        ...
        <button class="blue_btn" style="margin-top: 45px;margin-bottom: 100px;" onclick="ReplaceUserInfo()">Далее</button>
    </div>
</div>
    ...
    function ReplaceUserInfo(){
        ...
        send.then((result) => {
            ...
            if (result.status == true) {
                ...
                window.location.href = 'http://app.vprockit.ru/MakeFirstQuest';
            } else {
                alert(result.error);
            }
        });
