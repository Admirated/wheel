...
<div id="reg_menu" class="container" style="display: flex; justify-content: center; flex-direction: column">
    ...
    <h2 style="font-family: 'SF Pro Display',sans-serif;font-style: normal;font-weight: 600;font-size: 18px;line-height: 128.91%;/* or 23px */text-align: center;color: #000000;">Создайте вашу <span style="color: #007AFF;">задачу</span> </h2>

    <div class="container" id="contain" style="background-color: #ffffff; height: 300px;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);border-radius: 11px; margin-top: 50px;">
            ...
            <table style=" width: 100%;position: relative;top: 16px!important;">
                ...
                <tr>
                    ...
                    <td style=" border-bottom:2px solid #C4C4C4;border-left: 1.5px solid #C4C4C4; padding-left: 8px;">
                        ...
                        <input style="border: none; outline: none; padding-top: 5px;padding-bottom: 5px; font-size: 10px; background-color: #ffffff; color: #000000; width: 90%" data-placement="bottom" type="text" id="quest_deadline" name="appt" required placeholder="Сегодня в"></td>
                </tr>
                <tr>
                    ...
                    <td style=" border-bottom:2px solid #C4C4C4;border-left: 1.5px solid #C4C4C4; padding-left: 8px;">
                        ...
                        <input onclick="DateTime()" style="border: none; outline: none; padding-top: 5px; font-size: 10px; padding-bottom: 5px;  background-color: #ffffff; color: #000000; width: 90%"  type="text" id="quest_remind" name="appt" required placeholder="Сегодня в"></td></td>
                </tr>
                <tr>
    ...
    <button class="blue_btn" style="margin-top: 45px;margin-bottom: 100px;" onclick="CreateTask()">Создать</button>
</div>
<div class="col-sm-12">
...
<script>
    ...
    function DateTime() {
        ...
        document.getElementsByClassName('bootstrap-datetimepicker-widget')[0].innerHTML +='<div class="row justify-content-between" style="width: 100%;"> <div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div><div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div><div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div><div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div><div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div><div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div><div class="dayPick row "><label class="control-label" for="WorkWeek">Work Week</label> \n' +
            '    <input name="WorkWeek" class="form-control days-of-week" id="WorkWeek" type="checkbox"> </div></div> <input id="c1" type="checkbox">\n' +
    ...
    function CreateTask() {
        document.getElementById('circle_id').value ={{$PageInfo['circle']->id}};
        ...
        let id = document.getElementById('circle_id').value;
        ...
        send.then((result) => {
            ...
            if (result.status == true) {
                alert('Задание' + ' ' + name + ' ' + 'успешно создано!');
        ...
        $('#quest_deadline').datetimepicker({locale: 'ru', widgetPositioning: {
                vertical: "bottom"
            }});
        $('#quest_remind').datetimepicker({locale: 'ru',widgetPositioning: {
                vertical: "bottom"
            }});
